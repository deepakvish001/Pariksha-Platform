...
import { Lock, Eye, EyeOff, Shield, Loader2, AlertTriangle } from "lucide-react";
      ...
      <SettingsCard delay={0}>
        ...
        {isOAuthUser ? (
          <div className="text-center py-12">
            ...
            <p className="text-white/60">You signed in with Google.</p>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="••••••••"
                  className="pl-10 pr-10 bg-black/30 border-white/[0.08] text-white placeholder:text-white/30 focus:border-blue-500/50"
                />
                <button
                  type="button"
      ...
      <SettingsCard delay={0.05}>
        ...
        <div className="space-y-3">
          {[
            ...
            >
              <div className="w-1.5 h-1.5 mt-2 rounded-full bg-amber-400" />
