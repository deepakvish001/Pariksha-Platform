    ...
    >
      ...
      >
        ...
        <div className="relative">
          ...
          >
            <PhaseIcon className="h-6 w-6 text-white drop-shadow-sm" />
          </motion.div>
          
          {/* Phase number badge */}
          <div className={cn(
            "absolute -top-1 -right-1 h-5 w-5 rounded-full flex items-center justify-center",
            "bg-background border-2 border-border shadow-sm text-[10px] font-bold",
            phaseStyle.text
          )}>
            {phase}
          </div>
          ...
          {isComplete && (
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              className="absolute -bottom-1 -right-1 h-5 w-5 rounded-full bg-emerald-500 flex items-center justify-center shadow-md"
            >
