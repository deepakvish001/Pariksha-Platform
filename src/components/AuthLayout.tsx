...
const testimonials = [
  {
    ...
    avatar: "PS",
    content: "UniDash completely transformed how I manage my studies. My GPA improved by 0.8 points!",
    rating: 5,
  },
  {
    name: "Rahul Verma",
  ...
  },
  {
    ...
    avatar: "AP",
    content: "As someone juggling multiple projects, UniDash keeps everything organized perfectly.",
    rating: 5,
  },
];
