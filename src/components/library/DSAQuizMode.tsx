 ...
 const QUIZ_PRESETS: QuizPreset[] = [
   {
     id: "quick-easy",
     name: "Quick Warm-up",
     description: "5 easy problems, 60 seconds each",
     icon: <Sparkles className="h-5 w-5" />,
     config: { questionCount: 5, timePerQuestion: 60, topic: "all", difficulty: "Easy" },
     color: "from-emerald-500/20 to-green-500/20 border-emerald-500/30",
   },
   {
     id: "arrays-focus",
     name: "Array Mastery",
     description: "10 array problems, mixed difficulty",
     icon: <Code className="h-5 w-5" />,
     config: { questionCount: 10, timePerQuestion: 90, topic: "arrays", difficulty: "all" },
     color: "from-blue-500/20 to-cyan-500/20 border-blue-500/30",
   },
   {
     id: "dp-challenge",
     name: "DP Challenge",
     description: "10 dynamic programming problems",
     icon: <Brain className="h-5 w-5" />,
     config: { questionCount: 10, timePerQuestion: 120, topic: "dynamic-programming", difficulty: "all" },
     color: "from-purple-500/20 to-pink-500/20 border-purple-500/30",
   },
   {
     id: "speed-run",
     name: "Speed Coding",
     description: "15 problems, 45 seconds each",
     icon: <Flame className="h-5 w-5" />,
     config: { questionCount: 15, timePerQuestion: 45, topic: "all", difficulty: "all" },
     color: "from-orange-500/20 to-red-500/20 border-orange-500/30",
   },
   {
     id: "interview-prep",
     name: "Interview Prep",
     description: "20 mixed problems, comprehensive",
     icon: <Medal className="h-5 w-5" />,
     config: { questionCount: 20, timePerQuestion: 90, topic: "all", difficulty: "all" },
     ...
     return (
       <Card className="border-primary/20 bg-card/80 backdrop-blur">
         ...
         <CardContent className="space-y-6">
           ...
           {showLeaderboard && user && <QuizLeaderboard quizType="dsa" currentUserId={user.id} />}
         </CardContent>
       </Card>
     );
   }
