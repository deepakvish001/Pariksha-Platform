 ...
 const QUIZ_PRESETS: QuizPreset[] = [
   {
     ...
     config: { questionCount: 5, timePerQuestion: 45, category: "basics", difficulty: "Easy" },
     color: "from-emerald-500/20 to-green-500/20 border-emerald-500/30",
   },
   {
     id: "joins-focus",
     name: "Join Master",
     description: "10 JOIN questions, mixed difficulty",
     icon: <Database className="h-5 w-5" />,
     config: { questionCount: 10, timePerQuestion: 60, category: "joins", difficulty: "all" },
     color: "from-blue-500/20 to-cyan-500/20 border-blue-500/30",
   },
   {
     id: "window-challenge",
     name: "Window Functions",
     description: "10 advanced window function problems",
     icon: <Brain className="h-5 w-5" />,
     config: { questionCount: 10, timePerQuestion: 90, category: "window-functions", difficulty: "all" },
   ...
   },
   {
     ...
     config: { questionCount: 20, timePerQuestion: 60, category: "all", difficulty: "all" },
