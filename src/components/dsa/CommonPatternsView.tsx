...
function PatternDetailDialog({
  ...
  const cx = pattern ? splitComplexity(pattern.complexity) : { time: "", space: "" };
  const whenToUse = pattern ? deriveWhenToUse(pattern) : [];

  return (
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent className="p-0 gap-0 max-w-[1100px] w-[96vw] h-[92vh] overflow-hidden bg-background border-border/40">
        {pattern && (
          <div className="flex h-full flex-col">
            {/* Top breadcrumb bar */}
            <div className="flex items-center justify-between gap-3 border-b border-border/40 px-4 md:px-6 py-3 bg-card/30">
              <div className="flex items-center gap-3 min-w-0">
                ...
                >
                  <XIcon className="h-3.5 w-3.5" /> Patterns
                </Button>
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="mx-auto w-full max-w-5xl px-4 md:px-8 py-6 space-y-6">
                ...
                <DialogHeader className="sr-only">
                  ...
                  <DialogDescription>{pattern.subtitle}</DialogDescription>
                </DialogHeader>
                ...
                <section className="rounded-xl border border-sky-500/30 bg-gradient-to-br from-sky-500/10 via-card/40 to-card/40 p-5 md:p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="min-w-0 flex-1">
                      <h2 className="text-2xl md:text-3xl font-bold leading-tight flex items-center gap-2 flex-wrap">
