 ...
 import { Users, Search, X, Trophy, Check, Minus, Loader2 } from "lucide-react";
         ...
         {!comparison ? (
           <>
             ...
             <div className="relative">
               ...
               <Input
                 placeholder="Search for a user to compare..."
                 value={searchQuery}
             ...
             {searchQuery.length < 2 && (
               <p className="text-sm text-muted-foreground text-center py-4">
                 Search for a friend to compare your achievements
               </p>
             )}
           </>
         ) : isLoading ? (
