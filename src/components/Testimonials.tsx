...
const testimonials = [
  ...
  },
  {
    ...
    avatar: "VS",
    content: "The streak system kept me accountable during my placement prep. Ended up cracking interviews at 4 top companies. UniDash was my secret weapon!",
    rating: 5,
  },
  {
    name: "Sneha Reddy",
  ...
  },
  {
    ...
    avatar: "KN",
    content: "Medical school is intense, but UniDash helped me stay on top of everything. The note-taking integration is seamless with my study workflow.",
    rating: 5,
  },
  {
    name: "Aditya Kumar",
    ...
    avatar: "AK",
    content: "From tracking assignments to planning for CAT prep, UniDash handles it all. The weekly reports are incredibly insightful for self-improvement.",
    rating: 5,
  },
  {
    name: "Riya Gupta",
    ...
    avatar: "RG",
    content: "Managing case readings and moot court prep used to be chaotic. UniDash brought structure to my legal studies. Highly recommended!",
    rating: 5,
  },
];
