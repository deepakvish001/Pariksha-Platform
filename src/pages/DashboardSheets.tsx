...
const sheets = [
  ...
  },
  {
    ...
    title: "Junior Training V7.0 — A",
    description: "201 beginner CP problems — Codeforces, UVA & SPOJ",
    category: "CP",
    problems: 201,
    difficulty: "Easy",
    starred: true,
  },
  {
    ...
    title: "Junior Training V7.0 — B",
    description: "177 CP problems — BFS, DP, Greedy, Geometry & more",
    category: "CP",
    problems: 177,
    difficulty: "Easy-Medium",
    starred: true,
  },
  {
    ...
    title: "Junior Training V7.0 — C1",
    description: "162 CP problems — Primes, Algebra, Backtracking, DP & Probability",
    category: "CP",
    problems: 162,
    difficulty: "Medium",
    starred: true,
  },
  {
    ...
    title: "Junior Training V7.0 — C2",
    description: "167 CP problems — Game Theory, Dijkstra, Geometry, DP & Graphs",
    category: "CP",
    problems: 167,
    difficulty: "Medium",
    starred: true,
  },
  {
    ...
    title: "Junior Training V7.0 — D1",
    description: "146 CP problems — Segment Trees, Two Pointers, DP Masks & Tries",
    category: "CP",
    problems: 146,
    difficulty: "Medium-Hard",
    starred: true,
  },
  {
    ...
    title: "Junior Training V7.0 — D2",
    description: "144 CP problems — DP Games, KMP, Max Flow & more",
    category: "CP",
    problems: 144,
    difficulty: "Hard",
    starred: true,
  },
  {
    ...
    title: "Junior Training V7.0 — D3",
    description: "156 advanced CP problems — SCC, advanced DP & Graph algorithms",
    category: "CP",
    problems: 156,
    difficulty: "Hard",
    starred: true,
